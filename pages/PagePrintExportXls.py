...
def Page():
    ...
    keyTitleMap.append({"column": "lineName", "title": "线路"})
    keyTitleMap.append({"column": "peopleNum", "title": "人数"})
    keyTitleMap.append({"column": "companyName", "title": "单位"})
    keyTitleMap.append({"column": "departmentName", "title": "部门"})
    keyTitleMap.append({"column": "contactName", "title": "联系人"})
    keyTitleMap.append({"column": "contactInfo", "title": "联系方式"})
    keyTitleMap.append({"column": "totalMoney", "title": "总金额"})
    keyTitleMap.append({"column": "leftMoney", "title": "结余金额"})
    
    return "统计", keyTitleMap, db.session.execute(GenerateSql()).fetchall()
